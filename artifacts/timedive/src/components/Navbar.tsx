...
import { Compass, Settings, LogOut, User, Sparkles, BookOpen, Map } from 'lucide-react';
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {user ? (
            <>
              ...
              <Link href="/explore" className="hidden lg:flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors">
                <Map size={18} /> Explore
              </Link>
